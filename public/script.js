...
const doctors = [
  { id: 'Dr. Martin Carder', name: 'Dr. Martin Carder', spec: 'Dentist', rating: '4.9', exp: '8 Yrs', patients: '1.2K+', bio: 'Dr. Martin Carder is a highly respected dental and oral health specialist with over 8 years of experience.', img: 'https://i.pravatar.cc/150?u=doc1' },
  { id: 'Dr. Sylvia', name: 'Dr. Sylvia', spec: 'General Practitioner', rating: '4.8', exp: '5 Yrs', patients: '800+', bio: 'Dr. Sylvia specializes in general practice and preventative care.', img: 'https://i.pravatar.cc/150?u=doc2' },
  { id: 'Dr. John Smith', name: 'Dr. John Smith', spec: 'Cardiologist', rating: '5.0', exp: '12 Yrs', patients: '2.5K+', bio: 'Dr. John Smith is known for his excellence in cardiology.', img: 'https://i.pravatar.cc/150?u=doc3' },
  { id: 'Dr. Patil', name: 'Dr. Patil', spec: 'Orthopedics', rating: '4.7', exp: '10 Yrs', patients: '1.8K+', bio: 'Dr. Patil is an orthopedic surgeon specializing in knee and joint replacements.', img: 'https://i.pravatar.cc/150?u=doc4' },
  { id: 'Dr. Baviskar', name: 'Dr. Baviskar', spec: 'Pediatrician', rating: '4.9', exp: '6 Yrs', patients: '1.1K+', bio: 'Dr. Baviskar has a passion for children health and pediatric wellness.', img: 'https://i.pravatar.cc/150?u=doc5' },
  { id: 'Dr. Bhoite', name: 'Dr. Bhoite', spec: 'Neurologist', rating: '4.8', exp: '15 Yrs', patients: '3K+', bio: 'Dr. Bhoite is a senior neurologist dealing with disorders of the nervous system.', img: 'https://i.pravatar.cc/150?u=doc6' }
];
